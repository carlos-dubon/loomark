  ...
  return (
    ...
    >
      <InputPrimitive
        ...
        data-slot="input"
        className={cn(
          "w-full min-w-0 rounded-[inherit] px-[calc(--spacing(3)-1px)] outline-none [transition:background-color_5000000s_ease-in-out_0s] file:me-3 file:bg-transparent file:text-sm file:font-medium file:text-foreground placeholder:text-placeholder",
          size === "sm" ? "min-h-8" : "min-h-8.5 sm:min-h-7.5",
          type === "search" &&
