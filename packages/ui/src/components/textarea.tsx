  ...
  return (
    ...
    >
      <textarea
        data-slot="textarea"
        className={cn(
          "field-sizing-content w-full rounded-[inherit] px-[calc(--spacing(3)-1px)] py-[calc(--spacing(1.5)-1px)] outline-none placeholder:text-placeholder",
          size === "sm" ? "min-h-14" : "min-h-17.5"
        )}
        {...props}
      />
    </span>
